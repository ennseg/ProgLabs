...
public class RemoveLower extends CommandManager {
    ...
    public RemoveLower(CollectionManager collectionManager, DataBaseConnection dbconnection) {
    ...
    public ExecutionResponse apply(Object arguments) throws SQLException {
        ...
        try {
            ...
            return new ExecutionResponse(true, "Удалено " + idsToRemove.size() + " элементов, меньших заданного.");
