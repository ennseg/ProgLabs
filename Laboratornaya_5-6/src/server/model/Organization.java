...
public class Organization implements Validatable, Serializable, Comparable<Organization> {
     ...
     * @return nothing
     */
    public Organization(int id, String name, Coordinates coordinates, LocalDateTime creationDate, Double annualTurnover, String fullName, long employeesCount, OrganizationType type, Address postalAddress) {
        this.id = id;
        this.name = name;
        ...
        if (id >= CollectionManager.getNowId()) {CollectionManager.setNowId(id + 1);}
    } // чтение с файла
     ...
     * @return nothing
     */
    public Organization(String name, Coordinates coordinates, Double annualTurnover, String fullName, long employeesCount, OrganizationType type, Address postalAddress) {
        this(CollectionManager.getNowId(), name, coordinates, LocalDateTime.now(), annualTurnover, fullName, employeesCount, type, postalAddress);
